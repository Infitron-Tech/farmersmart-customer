...
const MarketplacePage: NextPageWithLayout<MarketplacePageProps> = ({
  initialCategories,
  initialBanners,
  initialProducts,
  initialBrands,
...
// Use MarketplaceLayout instead of DefaultLayout
MarketplacePage.getLayout = (page) => (
  <MarketplaceLayout>{page}</MarketplaceLayout>
);

export const getServerSideProps: GetServerSideProps<MarketplacePageProps> | undefined =
  isSSR()
    ? async (context) => {
        try {
